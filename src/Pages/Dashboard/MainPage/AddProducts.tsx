    ...
    return (
        <div className="w-full mx-12  pt-20">
           ...
           <div className="w-full">
            ...
            <select className="w-full p-2 border-2 rounded-md" {...register("Category")} name="" id="">
                <option  value="Select Products Category">Select Products Category</option>
                <option value="">Chair</option>
                <option value="">Sofa</option>
                <option value="">Table</option>
                <option value="">Bed</option>
                <option value="">Bookcases</option>
